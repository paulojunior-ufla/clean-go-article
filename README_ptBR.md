...
Como pessoas desenvolvedoras, às vezes, somos tentados(as) a escrever código de uma maneira que seja conveniente no momento, sem considerar as boas práticas; isso torna as revisões de código e os testes mais difíceis. De certa forma, estamos <em>codificando</em>&mdash; e, ao fazer isso, tornamos mais difícil para os outros decodificar nosso trabalho. Mas, nós queremos que nosso código seja utilizável, legível e manutenível. E isso requer codificar da maneira <em>certa</em>, não na maneira mais fácil.
